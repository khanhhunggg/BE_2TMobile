...
__decorate([
    (0, typeorm_1.ManyToOne)(() => cart_detail_entity_1.CartDetail, { nullable: true }),
    (0, typeorm_1.JoinColumn)({ name: 'cart_detail_id' }),
    __metadata("design:type", cart_detail_entity_1.CartDetail)
], OrderDetail.prototype, "cartDetail", void 0);
__decorate([
...
exports.OrderDetail = OrderDetail = __decorate([
    (0, typeorm_1.Entity)('tbl_order_details')
], OrderDetail);
